...
export const es = {
  common: {
    ...
    themeLight: 'Claro',
    footer:
      'Herramienta no oficial. Las puntuaciones siguen los <0>criterios oficiales CRS de IRCC</0>; solo como referencia. Los datos permanecen en tu navegador y la herramienta funciona sin conexión.',
