...
export const es = {
  ...
  form: {
    ...
    workingInCanada: 'Trabajando actualmente en Canadá (la experiencia se acumula en las proyecciones)',
    foreignWork: 'Experiencia laboral extranjera (últimos 10 años)',
    workingAbroad: 'Trabajando actualmente en el extranjero (la experiencia se acumula en las proyecciones)',
